...
## Project Structure
    ...
    ├── testapiautoteammemb_56860  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_56860`
...
2. Clone this repo and `cd testapiautoteammemb_56860`
